    ...
    <div class="img">
        ...
        <nav class="navbar fixed-top">
            <div class="container-fluid">
                ...
                <div class="masuk">
                    <a href="{{ route('registrasi') }}"><button type="button" class="btn btn-red">Daftar</button></a>
                    <a href="{{ route('login') }}"><button type="button" class="btn btn-warning">Masuk</button></a>
                </div>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('profil') }}">Setting</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="#">Saldo</a>
                            </li>
                            <li class="nav-item">
