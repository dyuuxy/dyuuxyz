...
<body>
    <div class="container">
        ...
        <div class="back">
            <a href={{ route('minuman') }}><i class="fa-solid fa-arrow-left"></i></a>
        </div>
        ...
        <div class="content-container">
            ...
            <div class="image-section">
                ...
                <!-- Price section -->
                <div class="price">
                  <a href={{ route('pembayaranminuman') }}> <button class="mamat"> Mulai Dari <p class="harga">Rp250.000</p></button></a>
                </div>
