...
<body>
    <div class="container">
        ...
        <h2>Kabupaten Bone Bolango</h2>
        <div class="grid">
            <a href="#"><button class="button"> Suwawa</button></a>
            <a href="#"><button class="button"> Suwawa Timur</button></a>
            <a href="#"><button class="button"> Bulango Ulu</button></a>
            <a href="#"><button class="button"> Bulango Selatan</button></a>
            ...
            <a href="#"><button class="button"> Botupingge</button></a>
        </div>
        <div class="profile">
