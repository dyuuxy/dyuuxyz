...
<body>
    ...
    <div class="feature-grid">
        <a href="{{ route('layanansdm') }}">
            <img src="{{ asset('img/lay3.png') }}" alt="SDM">
            <p>SDM</p>
        </a>
        <a href="{{ route('kemasan') }}">
            <img src="{{ asset('img/lay2.png') }}" alt="Kemasan">
            <p>Kemasan</p>
        </a>
        <a href="{{ route('trasportasi') }}">
            <img src="{{ asset('img/lay1.png') }}" alt="Distribusi">
            <p>Distribusi</p>
        </a>
        <a href="{{ route('layananmanajemen') }}">
            <img src="{{ asset('img/lay6.png') }}" alt="Manajemen">
            <p>Manajemen</p>
        </a>
        <a href="{{ route('perpajakan') }}">
            <img src="{{ asset('img/lay5.png') }}" alt="Pajak">
            <p>Pajak</p>
        </a>
        <a href="#">
            <img src="{{ asset('img/lay4.png') }}" alt="Pendanaan">
            <p>Pendanaan</p>
        </a>
    </div>
