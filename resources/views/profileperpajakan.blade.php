...
<body>
    <div class="container">
        ...
        <div class="back">
            <a href={{ route('perpajakan') }}><i class="fa-solid fa-arrow-left"></i></a>
        </div>
        ...
        <div class="content-container">
            ...
            <div class="image-section">
                ...
                <h2>Konsultan Perpajakan dan Keuangan</h2>
                ...
                <!-- Price section -->
                <div class="price">
                  <a href={{ route('pembayaranpajak') }}> <button class="mamat"> Mulai Dari <p class="harga">Rp250.000</p></button></a>
                </div>
                ...
                <div class="description">
                    <h3>Deskripsi</h3>
                    <p>
                        Konsultan manajemen strategi melakukan analisis mendalam tentang situasi perusahaan, <br>termasuk faktor internal dan eksternal yang memengaruhi kinerja bisnis. <br>membantu perusahaan merumuskan tujuan jangka panjang, visi, dan misi yang sesuai dengan tujuan bisnis.
                    </p>
                </div>
