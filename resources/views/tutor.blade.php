...
<head>
    ...
    <title>Cara mmembuat product</title>
</head>
<body>
    <div class="container">
        <div class="back">
        ...
        <h3 class="layanan">Cara Membuat Product</h3>
        <div class="icon">
      ...
      <div class="kotak">
        <a href="{{ route('makanan') }}"><button class="satu"><h3>Membuat Makanan</h3></button></a>
        <a href="{{ route('minuman') }}"><button class="dua"><h3>Membuat Minuman</h3></button></a>
        <a href="{{ route('jajan') }}"><button class="tiga"><h3>Jajanan Pasar</h3></button></a>
      </div>

      <div class="kotak1">
        <a href="{{ route('roti') }}"><button class="satu"><h3>Membuat Roti</h3></button></a>
        <a href="{{ route('desain') }}"><button class="dua"><h3>Praktek Desain</h3></button></a>
        <a href="{{ route('bumbu') }}"><button class="tiga"><h3>Membuat Kue</h3></button></a>
      </div>
